...
print(binary_search_with_upper_bound(arr, 3.0))  # -> (steps, 3.3)
print(binary_search_with_upper_bound(arr, 4.7))  # -> (steps, 4.7) exact match
print(binary_search_with_upper_bound(arr, 7.5))  # -> (steps, None)
print(binary_search_with_upper_bound(arr, 0.1))  # -> (steps, 0.5)
